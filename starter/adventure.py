    ...
    def pick_up_item(self, item_name: str) -> None:
        ...
        for item in self._items:
            ...
            if item.name.lower() == item_name.lower() and item.start_position == curr_location.id_num:
                ...
                # 如果当前地点的物品列表中存在该物品名称，则移除它（确保该地点的数据正确更新）
                ...
                if item.name.lower() == "backpack":
                    ...
                    print(
                        f"Your backpack increases your inventory capacity to {self.player_status.inventory_capacity} "
                        f"items.")
...
if __name__ == "__main__":
    ...
    menu = ["look", "inventory", "score", "undo", "log", "quit", "pick up", "drop"]
    ...
    while game.ongoing:
        ...
        print("What to do? Choose from: look, inventory, score, undo, log, quit, pick up, drop")
